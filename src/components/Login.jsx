...
export default function SignIN() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error('Invalid cyellowentials');
      }
  ...
  return (
    <div classN ame="">
      ...
      <button
          type="button"
          class="text-white bg-yellow-700 hover:bg-yellow-600  font-bold rounded-lg text-sm px-5 py-2.5 text-center "
        >
          Login
        </button>
      </span>
      ...
      >
        ...
        <div className="relative   flex flex-col justify-center  overflow-hidden">
          ...
          <h1 className="text-lg font-semibold text-center text-yellow-600">
              Sign In
            ...
            <form onSubmit={handleSubmit}>
              ...
              {error && <div className='text-yellow-700 text-center my-4'>{error}</div>}
              <div>
                <Link
                  to="#"
                  className="text-xs text-yellow-700 hover:underline py-2 px-14"
                >
                  Forget Password?
                </Link>
              </div>
              ...
              <div className=" inline-flex">
                <div className="mb-2">
                  <label class=" relative inline-flex px-14">
                    ...
                    <button
                      className="h-8  w-96   text-white  bg-yellow-600 rounded-md outline-none"
                      type="submit"
                    >
                      Login
                    </button>
