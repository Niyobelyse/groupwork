  ...
  return (
    <div className="">
      <span variant="outlined" onClick={handleClickOpen}>
        <button
          type="button"
          class="text-black bg-yellow-700 hover:bg-yellow-600  font-medium rounded-lg text-sm px-5 py-2.5 text-center "
        >
          Sign Up
        </button>
      </span>
      ...
      >
        ...
        <div className="relative flex flex-col justify-center  overflow-hidden">
          <div className="w-full p-4 my-auto bg-white rounded-md shadow-xl lg:max-w-xl py-12">
            <h1 className="text-lg  text-center font-bold text-yellow-700">
              Sign Up
              ...
              <div className=" inline-flex">
                <div className="mb-2">
                  <label class=" relative inline-flex px-14">
                    ...
                    <button
                      className="h-8  w-96   text-white  bg-yellow-700 rounded-md outline-none"
                      type="submit"
                    >
                      Signup
                    </button>
