  ...
  return (
    <>
      <div className="container mx-auto py-5">
        <div className="bg-yellow-900  w-5/5 mx-32 py-14 mt-14 mb-14 justify-center">
          ...
          <div className="mx-auto w-3/5">
            <form className="mb-10" onSubmit={handleSubmit}>
              ...
              <div className="mb-6 block">
                <button
                  type="submit"
                  className="float-right text-white bg-yellow-600 hover:bg-yellow-600 focus:ring-4 focus:outline-none focus:ring-yellow-300 font-lg rounded-lg text-sm px-5 py-2.5 text-center"
                >
                  Submit
                </button>
              </div>
